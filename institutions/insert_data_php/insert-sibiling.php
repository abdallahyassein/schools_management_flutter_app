...
$student_id = 0;
$name =  $date_of_birth = "";
$name_err = $date_of_birth_err =$student_id_err= "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (
     ...
     empty($name_err) &&  empty($date_of_birth_err) &&  empty($student_id_err)
  ) {
            ...
            <div class="card-body">
              ...
              <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group <?php echo (!empty($date_of_birth_err)) ? 'has-error' : ''; ?>">
                  ...
                  <input type="text" name="date_of_birth" class="form-control" value="<?php echo $date_of_birth; ?>" placeholder="Enter Date Of Birth">

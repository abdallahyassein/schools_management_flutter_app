...
<head>
    <meta charset="utf-8">
    <title>Search Medications</title> <!-- title for the page  -->
...
<body>
    ...
    <div class="col-13 col-sm-6 col-md-5 mx-auto" style="padding: 2%;"> 
        <div class="form-group">
          ...
          <input type="text" name="search" id="search" autocomplete="off" class="form-control" placeholder="Enter Student">
        ...
        <table class="table table-bordered table-striped table-dark">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;">Time Of Medication</th>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($user = mysqli_fetch_array($result)) {
                            ...
                            echo "<td align='center'>" . $user['description'] . "</td>";
                            echo "<td align='center'>" . $user['time_of_treatment'] . "</td>";
                            echo "<td align='center'>" . $user['date_of_register'] . "</td>";
                            echo ("<td align='center'><a href=\"../edit_data/edit-medication.php?medication_id=".$user['id']."\">Edit</a></td>");
                            echo ("<td align='center'><a href=\"../remove_data/remove-medication.php?medication_id=".$user['id']."\">Remove</a></td>");
                            echo "</tr>";
    ...
    $(document).ready(function() {
      $("#search").keyup(function() {
        ...
        if (query != "") {
          $.ajax({
            url: '../search_data/search-medication.php',
            method: 'POST',
            data: {
              query: query
            },

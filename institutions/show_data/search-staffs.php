...
<head>
    <meta charset="utf-8">
    <title>Search Staff</title> <!-- title for the page  -->
...
<body>
    ...
    <div class="col-13 col-sm-6 col-md-5 mx-auto" style="padding: 2%;"> 
        <div class="form-group">
          <h2 class="text-center" style=" font-size: 35px; font-family:'Coustard', serif; color: #FFFFFF; background-color:#353a40;">Search Staff Member</h2>
          <input type="text" name="search" id="search" autocomplete="off" class="form-control" placeholder="Enter Staff Member Full Name">
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($user = mysqli_fetch_array($result)) {
                            ...
                            echo "<td align='center'>" . $user['job'] . "</td>";
                            ...
                            echo ("<td align='center'><a href=\"../edit_data/edit-staff.php?staff_id=".$user['id']."\">Edit</a></td>");
                            echo ("<td align='center'><a href=\"../remove_data/remove-staff.php?staff_id=".$user['id']."\">Remove</a></td>");
                            echo "</tr>";
    ...
    $(document).ready(function() {
      $("#search").keyup(function() {
        ...
        if (query != "") {
          $.ajax({
            url: '../search_data/search-staff.php',
            method: 'POST',
            data: {
              query: query
            },
